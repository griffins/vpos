        ...
        <ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
            <li class="">
                <a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown">
                    <img src="img/avatars/sunny.png" alt="{{ auth()->user()->profile['firstName'] }}" class="online"/>
                </a>
...
<aside id="left-panel">
    ...
    <div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as is --> 
					...
					<a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">
						...
						<span>
							{{ auth()->user()->personalAccount[0]['firstName']  . ' ' . auth()->user()->personalAccount[0]['otherName'] }}
						</span>
    ...
    <a href="#ajax/difver.html" class="btn btn-primary nav-demo-btn"><i class="fa fa-info-circle"></i> SmartAdmin
        Package (187 MB)</a>
...
<div id="shortcut">
    <ul>
        ...
        <li>
            <a href="{{ url("/profile#profile") }}" class="jarvismetro-tile big-cubes selected bg-color-pinkDark"> <span
